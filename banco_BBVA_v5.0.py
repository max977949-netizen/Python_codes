...
def invertir():
    ...
    if rad <= 50:
        ...
        texto_ventana.config(text=f"se duplicó {saldo}")
    ...
    if rad > 50:
        ...
        saldo=saldo/2
        texto_ventana.place(relx=0.5, rely=0.5, anchor="center")
        texto_ventana.config(text=f"se dividió {saldo}")
...
boton_casino = tk.Button(ventana, text="apuesta", fg="gold", bg="black", command=casino_gano)
